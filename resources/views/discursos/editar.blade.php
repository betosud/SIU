...
@section('content')
            ...
            <div class="col s12 m12 z-depth-3 card-panel">
                <div class="row">
                    <div class="input-field col s12 center">
                        <h6 class="center login-form-text">Editar Discurso</h6>
                        <h6 class="center login-form-text">{!! $discurso->nombre !!}</h6>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row margin">
                        <div class="input-field col  m6 s12">
                            ...
                            {!! Form::text('fecha',$discurso->fecha,['class'=>'validate input-field datepicker','id'=>'datepicker','placeholder'=>'Seleeciona Fecha'])  !!}
                            @if ($errors->has('fecha'))
                        ...
                        <div class="input-field col  m6 s12">
                            ...
                            {!! Form::text('hora',$discurso->horahm,['class'=>'validate input-field pick-a-time','id'=>'pick-a-time','placeholder'=>'Seleeciona Hora'])  !!}
                            @if ($errors->has('hora'))
                                <span class="help-block red-text">
                    ...
                    <div class="row margin">
                        <div class="input-field col m6 s12">
                            ...
                            {!! Form::text('nombre',$discurso->nombre,['class'=>'validate input-field','id'=>'nombre','placeholder'=>'Ingresa el Nombre completo'])  !!}
                        ...
                        <div class="input-field col m6 s12">
                            ...
                            <label for="tema" data-error="dato no valido" data-success="Correcto" class="left-align">Tema Asignado</label>
                            {!! Form::text('tema',$discurso->tema,['class'=>'validate input-field','id'=>'tema','placeholder'=>'Tema Asignado'])  !!}
                            @if ($errors->has('tema'))
                                <span class="help-block red-text">
                    ...
                    <div class="input-field col m6 s12">
                        ...
                        {!!  Form::select('duracion', ['5'=>'5 Minutos','10'=>'10 Minutos','15'=>'15 Minutos','20'=>'Mas de 20 Minutos'],null,['placeholder'=>'Duracion','class'=>'validate input-field duracion','id'=>'duracion']) !!}
                    ...
                    <div class="row margin">
                        <div class="input-field col m6 s12">
                            ...
                            {!! Form::text('lugar',$discurso->lugar,['class'=>'validate input-field','id'=>'lugar','placeholder'=>'Lugar de la Asignacion'])  !!}
                            @if ($errors->has('lugar'))
                                <span class="help-block red-text">
    ...
    <div id="salir" class="modal">
        ...
        <div class="modal-footer">
            <a href="{!! route('discursos') !!}" class="modal-action modal-close waves-effect waves-green btn-flat green lighten-2">De Acuerdo</a>

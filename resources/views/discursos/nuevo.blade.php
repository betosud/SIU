            ...
            <div class="col s12 m12 z-depth-3 card-panel">
                <div class="row">
                    <div class="input-field col s12 center">
                        <h5 class="center login-form-text">Nuevo Discurso</h5>

                    </div>
                </div>

                <div class="container-fluid">
                    {!! Form::open(array('url' => 'guardardiscurso', 'method' => 'post','class'=>'form-horizontal')) !!}
                    ...
                    <div class="row margin">
                        ...
                        <div class="input-field col m6 s12">
                            ...
                            {!! Form::text('tema','',['class'=>'validate input-field','id'=>'tema','placeholder'=>'Tema Asignado'])  !!}
                            @if ($errors->has('tema'))
                                <span class="help-block red-text">

        ...
        <div class="col-md-10 col-lg-offset-1">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">{!! $asignacion->nombre !!}</h3>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class='date input-group' id='date'>
                            ...
                            {!! Form::text('fecha',$asignacion->fechadma,['placeholder'=>'Seleccione Fecha','class'=>'form-control']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class='date input-group' id='time'>
                            ...
                            {!! Form::text('hora',$asignacion->horahm,['placeholder'=>'Seleccione Hora','class'=>'form-control']) !!}
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class='date input-group' id='time'>
                            ...
                            {!! Form::text('nombre',$asignacion->nombre,['placeholder'=>'Nombre Completo','class'=>'form-control']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class='date input-group' id='time'>
                            ...
                            {!! Form::text('asignacion',$asignacion->asignacion,['placeholder'=>'Descripcion de la asignacion','class'=>'form-control']) !!}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class='date input-group' id='time'>
                            ...
                            {!! Form::text('lugar',$asignacion->lugar,['placeholder'=>'Lugar','class'=>'form-control']) !!}
                        </div>
                    </div>
                </div>

            ...
            <div class="col s12 m12 z-depth-3 card-panel">
                <div class="row">
                    <div class="input-field col s12 center">
                        <h6 class="center login-form-text">Editar Entrevista</h6>
                        <h6 class="center login-form-text">{!! $entrevista->nombre !!}</h6>
                    ...
                    <div class="row margin">
                        <div class="input-field col m6 s12">
                            ...
                            @if ($errors->has('realizado'))
                                <span class="help-block red-text">
                                <strong>{{ $errors->first('realizado') }}</strong>
                            </span>
                            @endif
                            <label for="realizado" data-error="dato no valido" data-success="Correcto" class="left-align ">Realizado</label>
                            <div class="form-group{{ $errors->has('realizado') ? ' has-error' : '' }}">
                            </div>
                        </div>
                        {{--</div>--}}

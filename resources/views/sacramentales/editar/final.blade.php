<div class="row margin">
    <div class="input-field col  m6 s12">
        ...
        {!! Form::text('himno_final',$sacramental->himno_final,['class'=>'validate input-field','id'=>'himno_final','placeholder'=>'Ingrse Nombre y Numero'])  !!}
    ...
    <div class="input-field col m6 s12">
        ...
        {!! Form::text('oracion_final',$sacramental->oracion_final,['class'=>'validate input-field','id'=>'oracion_final','placeholder'=>'Ingresa el Nombre completo'])  !!}
...
<div class="row margin">
    <div class="input-field col offset-l9 m3 s6">
        ...
        {!! Form::text('asistencia',$sacramental->asistencia,['class'=>'validate input-field asistencia','id'=>'asistencia','placeholder'=>'Total Asistencia'])  !!}

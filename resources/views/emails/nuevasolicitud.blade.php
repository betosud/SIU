                                                        ...
                                                        <tbody><tr>
                                                            ...
                                                            <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li style="text-align: justify;">IFE: <strong>{!! $sit->ife !!}</strong></li>
                                                                    ...
                                                                    <li style="text-align: justify;">Tipo Pago: <strong>{!! $sit->tipopagodsc !!}</strong></li>

                                                                </ul>
                                                                <br>
                                                                <p>Cualquier Duda sobre la solicitud puede realizarla con los lideres de <strong>{!! $sit->datosbarrio->nombreunidad !!}</strong></p>
                                                                <br>
                                                            </td>
                                                        </tr>
                                                        </tbody></table>

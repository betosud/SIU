                                        ...
                                        <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tbody><tr>
                                                ...
                                                <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                    ...
                                                    le solicitamos que pueda entregar los comprobantes del gasto

                                                    <ul>
                                                        <li style="text-align: justify;">Subirlos al SItema SIU</li>
                                                        <li style="text-align: justify;">Enviarlos al Correo <strong>{!! $sit->datosbarrio->email !!}</strong></li>
                                                        <li style="text-align: justify;">Entregarlos a los lideres de la unidad <strong>{!! $sit->datosbarrio->nombreunidad !!}</strong></li>
                                                    </ul>
                                        ...
                                        <table class="mcnButtonContentContainer" style="border-collapse: separate ! important;border-radius: 3px;background-color: #2BAADF;" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="font-family: Arial; font-size: 16px; padding: 15px;" class="mcnButtonContent" align="center" valign="middle">
                                                    <a class="mcnButton " title="Mostrar Solicitud" href="{!! URL::to('solicitud',array($sit->id,$sit->token)) !!}" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Subir Comprobantes</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>

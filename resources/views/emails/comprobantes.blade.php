                                        ...
                                        <table class="mcnImageContentContainer" style="min-width:100%;" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tbody><tr>
                                                <td class="mcnImageContent" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                                    ...
                                                    <img alt="" src="https://gallery.mailchimp.com/c2966d8b3d3e2af006c1d7f9f/images/37302360-a538-427f-af5e-14d73102018a.png" style="max-width:134px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage" align="middle" width="134">
                        ...
                        <td valign="top" id="templateBody"><table class="mcnTextBlock" style="min-width:100%;" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        ...
                                        <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tbody><tr>
                                                ...
                                                <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                    ...
                                                    <h1 style="text-align: center;">{!! $sit->datosbarrio->nombreunidad!!}</h1>

                                                    <p style="text-align: center;">Informacion y comprobantes del Gasto</p>
                                        ...
                                        <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tbody><tr>
                                                ...
                                                <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                    ...
                                                    <ul>
                                                        <li style="text-align: justify;"># sit: <strong>{!! $sit->idsit !!}</strong> </li>
                                                        <li style="text-align: justify;">Barrio:<strong>{!! $sit->datosbarrio->nombreunidad !!}</strong></li>
                                                        <li style="text-align: justify;"># Unidad:<strong>{!! $sit->idbarrio !!}</strong></li>
                                                        <li style="text-align: justify;">Fecha:<strong>{!! $sit->fechasit !!}</strong></li>
                                                        <li style="text-align: justify;">Pagable:<strong>{!! $sit->pagable !!}</strong></li>
                                                        <li style="text-align: justify;">Correo:<strong>{!! $sit->mail !!}</strong></li>
                                                        <li style="text-align: justify;">Monto:<strong>{!! $sit->cantidad !!}</strong></li>
                                                        <li style="text-align: justify;">Descripcion:<strong>{!! $sit->descripcion !!}</strong></li>
                                                        <li style="text-align: justify;">Organizacion:<strong>{!! $sit->organizacionnombre !!}</strong></li>
                                                        <li style="text-align: justify;">Categoria:<strong>{!! $sit->categorianombre !!}</strong></li>
                                                        <li style="text-align: justify;">Tipo de Pago:<strong>{!! $sit->tipopagodsc !!}</strong></li>
                                                        <li style="text-align: justify;">Pte. Organizacion:<strong>{!! $sit->pteorganizacionnombre !!}</strong></li>
                                                        <li style="text-align: justify;">Obispo:<strong>{!! $sit->obisponombre !!}</strong></li>
                                                        <li style="text-align: justify;">Status:<strong>{!! $sit->statusnombre !!}</strong></li>
                                                    </ul>
                                ...
                                <tr>
                                    <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" class="mcnButtonBlockInner" align="center" valign="top">
                                        <table class="mcnButtonContentContainer" style="border-collapse: separate ! important;border-radius: 3px;background-color: #2BAADF;" border="0" cellpadding="0" cellspacing="0">
                                            <tbody>
                                            <tr>
                                                <td style="font-family: Arial; font-size: 16px; padding: 15px;" class="mcnButtonContent" align="center" valign="middle">
                                                    <a class="mcnButton " title="Imprimir Formatos" href="{!! URL::to('solicitud',array($sit->id,$sit->token)) !!}" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Ver en linea</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                                                                                    ...
                                                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                                                        <tbody><tr>
                                                                                                            ...
                                                                                                            <td class="mcnFollowIconContent" align="center" valign="middle" width="24">
                                                                                                                <a href="http://www.facebook.com/estacaamecameca" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-facebook-48.png" style="display:block;" class="" height="24" width="24"></a>
                                                                                                            </td>
                                                                                                ...
                                                                                                <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" align="left" valign="middle">
                                                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                                                        <tbody><tr>
                                                                                                            ...
                                                                                                            <td class="mcnFollowIconContent" align="center" valign="middle" width="24">
                                                                                                                <a href="http://siu.estacaamecameca.org" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-link-48.png" style="display:block;" class="" height="24" width="24"></a>
                                                                                                            </td>
                                                                                                ...
                                                                                                <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" align="left" valign="middle">
                                                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                                                        <tbody><tr>
                                                                                                            ...
                                                                                                            <td class="mcnFollowIconContent" align="center" valign="middle" width="24">
                                                                                                                <a href="mailto:{!! $sit->datosbarrio->email !!}" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-forwardtofriend-48.png" style="display:block;" class="" height="24" width="24"></a>
                                                                                                            </td>

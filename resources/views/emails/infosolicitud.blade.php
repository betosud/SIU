                                        ...
                                        <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tbody><tr>
                                                ...
                                                <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                    ...
                                                    <p style="text-align: center;">Le informamos que su solicitud fue modificada a</p>
                                                    <br>
                                                    <h3 style="text-align: center;">{!! $sit->statusnombre !!}</h3>
                                                    <p>Para cualquier duda sobre su solicitud ingrese a Mostrar Solicitud para mas detalle o acuda con los lideres de la unidad <strong>{!! $sit->datosbarrio->nombreunidad !!}</strong></p>
                                        ...
                                        <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tbody><tr>
                                                ...
                                                <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                                                    ...
                                                    <ul>
                                                        <li style="text-align: justify;">Contar con identificacion Vigente</li>
                                                        <li style="text-align: justify;">Imprima su formato de solicitud y Entreguela Firmada a los lideres de <strong>{!! $sit->datosbarrio->nombreunidad !!}</strong></li>
                                                        <li style="text-align: justify;">Ingrese sus Factura del Gasto o entreguelas a los Lideres de <strong>{!! $sit->datosbarrio->nombreunidad !!}</strong></li>
                                                        <li style="text-align: justify;">Acuda al Banco <strong>{!! $sit->datosbarrio->datosbanco->nombre !!}</strong> antes de 10 dias habiles a partir del <strong>{!! $sit->fechasitdma !!}</strong></li>
                                                        <li style="text-align: justify;">Si no puede obtener su SIT solicitelo a los lideres de <strong>{!! $sit->datosbarrio->nombreunidad !!}</strong></li>
                                                    </ul>
                                        ...
                                        <table class="mcnButtonContentContainer" style="border-collapse: separate ! important;border-radius: 3px;background-color: #2BAADF;" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="font-family: Arial; font-size: 16px; padding: 15px;" class="mcnButtonContent" align="center" valign="middle">
                                                    <a class="mcnButton " title="Mostrar Solicitud" href="{!! URL::to('solicitud',array($sit->id,$sit->token)) !!}" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Mostrar Solicitud</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>

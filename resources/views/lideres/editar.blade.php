        ...
        <div class="col-md-10 col-lg-offset-1">
            <div class="panel panel-primary">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        {!! Form::text('nombre',$lider->nombre,['placeholder'=>'Nombre Completo','class'=>'form-control']) !!}
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('E-mail','',['class'=>'col-sm-2 control-label'])!!}
                    <div class="col-sm-9">
                        {!! Form::text('email',$lider->email,['placeholder'=>'correo@dominio.com','class'=>'form-control']) !!}
                    </div>
                </div>
                <div class="form-group">
                    {!! Form::label('Num. Telefono','',['class'=>'col-sm-2 control-label'])!!}
                    <div class="col-sm-9">
                        {!! Form::text('phone',$lider->phone,['placeholder'=>'telefono 10 digitos','class'=>'form-control']) !!}
                    </div>
                </div>
                ...
                {!! Form::open(['route'=>['eliminarlider',$lider->id],'method'=>'DELETE']) !!}
                    ...
                    <button class="btn btn-danger" onclick="return confirm('Seguro que deseas Eliminar al Lider')" type="submit" name="action">{!! trans('validation.attributes.delete') !!}
                    </button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{!! route('lideres') !!}" class="btn btn-success" role="button">Salir</a>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
